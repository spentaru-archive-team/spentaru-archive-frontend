...
export default function DashboardSkeleton() {
  const statItems = Array.from({ length: 5 });
          ...
          >
            ...
            <CardContent className="px-4 py-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm border border-primary/12 bg-primary/6 text-primary">
